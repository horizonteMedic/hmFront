...
import Ficha from "./views/jaspers/HojadeRutaDinamica/HojadeRutaDinamico.jsx";
...
import ModuloSalud from "./views/admin/panel-de-control/ModuloSalud/ModuloSalud.jsx";
    ...
    <>
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute TotalView={TotalView} />}>
          ...
          <Route path="/ModuloSalud" element={<ModuloSalud />} />
