...
const Modal = ({ closeModal }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-gray-800 bg-opacity-50 z-50">
      <div className="bg-white rounded-lg overflow-hidden shadow-xl w-[90%]"> {/* Ancho del modal ajustado al 90% del tamaño de la pantalla */}
        <div className="px-4 py-2 bg-gray-200 flex justify-between">
          <h2 className="text-lg font-bold">Historial</h2>
          <button onClick={closeModal} className="text-lg">&times;</button> {/* Aumenta el tamaño del icono de X */}
        </div>
        <div className="px-6 py-4 overflow-y-auto"> {/* Agrega más padding para que se vea mejor */}
          <div className="mb-4">
            <strong>D.N.I.:</strong> 33567143
          </div>
          <div className="mb-4">
            <strong>Paciente:</strong> MANTILLA HUAMAN CATALINO
          </div>
