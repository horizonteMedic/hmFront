...
const Modal = ({ closeModal }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-gray-800 bg-opacity-50 z-50">
      <div className="bg-white rounded-lg overflow-hidden shadow-xl w-[90%] h-[30%]"> {/* Ancho del modal ajustado al 90% del tamaño de la pantalla */}
        ...
        <div className="px-6 py-4 overflow-y-auto flex flex-wrap "> {/* Agrega flex-wrap para envolver los elementos */}
          ...
          <div className="w-full md:w-1/2 mb-4"> {/* Divide en dos columnas en pantallas medianas */}
            <span>Paciente : </span><div className="sombreado rounded px-2 py-1 inline-block"><strong> MANTILLA HUAMAN CATALINO</strong></div>
          </div>
