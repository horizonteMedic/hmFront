...
const ImportacionModal = ({ isOpen, onRequestClose, selectedSede, token, userlogued }) => {
  ...
  const handleDownloadExcelTemplate = () => {
    window.open('https://docs.google.com/spreadsheets/d/1n9B5qlCYMamOIqC6JH7o_Ymz1aQE9KFh/edit?usp=sharing&ouid=105230702023683005367&rtpof=true&sd=true', '_blank');
  };
