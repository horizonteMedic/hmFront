...
const NewHuellaFut = ({close}) => {
    ...
    const download = (e) => {
        ...
        for (let i = 0; i < data.length; i += 4) {
          ...
          // Detectamos fondo negro o casi negro (ajustable)
          if (r < 30 && g < 30 && b < 30) {
            // Hacemos el píxel transparente
            data[i + 3] = 0; // Alpha = 0
          }
        }
      
        ctx.putImageData(imageData, 0, 0); // Aplicamos la transparencia
            ...
            <div className="mx-auto bg-white rounded-lg shadow-lg w-[900px] relative">
                ...
                {/* Contenedor de dos columnas */}
                    ...
                    <div className='flex items-center justify-center w-auto h-auto mt-3 '>
                        <div  id='imagendiv' className='p-0 m-0 w-[320px] h-[480px] border-2 border-indigo-900'></div>
                    </div>
                    <div style={{ marginTop: 10, display: "none" }}>
                        {imageLink && (
