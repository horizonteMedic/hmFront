    ...
    <form className="w-full max-w-7xl mx-auto bg-white p-8 rounded shadow">
      <div className="flex flex-wrap items-center gap-6 mb-6">
        <div className="flex items-center gap-2">
          ...
          onKeyUp={(event) => {if(event.key === 'Enter')VerifyTR(form.norden,'con_panel3D',token,setForm,selectedSede)}} />
        </div>
      ...
      <div className="flex flex-wrap items-center gap-4 mb-4">
        <button type="button" onClick={(() => {SubmitConsentimientoLab(form,"con_panel3D",token, userlogued)})} className="bg-green-600 text-white px-6 py-3 rounded flex items-center gap-2 text-lg hover:bg-green-700">
