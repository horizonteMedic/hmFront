            ...
            <div className="w-auto">
                <div className="flex  items-center gap-8">
                    ...
                    <div className="flex">
                        ...
                        <input type="checkbox" name="chk2radio" className="mr-2 ml-4" checked={form.chk2No}
                            // onChange={() => NOPleurales(setForm)} id="chk2No" 
                            onChange={() => setForm(prev => ({ ...prev, chk2Si: false, chk2No: true, }))}
                        />
                        ...
                        { label: "", codeO: "chk2_12", codeD: "chk2_15", codeI: "chk2_18" }]
                            .map((item, idx) => (
                                <div key={idx} className="flex flex-row items-center gap-2 mb-1  font-semibold text-[11px] ">
                                    ...
                                    {/* Checkboxes sin letras al costado */}
                                    <div className="w-[35px] flex justify-center ">
                                        <input  type="checkbox" name={item.codeO} id={item.codeO} checked={form[item.codeO]} onChange={handleInputChangeChecked} /> <span className="ml-2 ">O</span>
                                    </div>
                                    <div className="w-[35px] flex justify-center">
                                        <input  type="checkbox" name={item.codeD} id={item.codeD} checked={form[item.codeD]} onChange={handleInputChangeChecked} /> <span className="ml-2">D</span>
                                    </div>
                                    <div className="w-[35px] flex justify-center">
                                        <input  type="checkbox" name={item.codeI} id={item.codeI} checked={form[item.codeI]} onChange={handleInputChangeChecked} /> <span className="ml-2">I</span>
                                    </div>
                                </div>
                            ))}
                    </div>
