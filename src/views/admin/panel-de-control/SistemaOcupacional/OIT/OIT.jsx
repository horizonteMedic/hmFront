...
import { PrintHojaR, PrintHojaSinDatos, SubmitOIT, VerifyTR } from './controller/OIT_controller';
        ...
        <h1 className="text-3xl font-bold mb-4 text-center">OIT</h1>
            <div className=' border rounded-md p-4 shadow-sm bg-white'>
                ...
                <div className='m-3 flex flex-col'>
                    <div className='flex flex-row items-center my-2'>
                        ...
                        <input type="text" name="lector" value={form.doctor} id="lector" disabled className='border w-[22%] min-w-[14%] rounded px-2 py-1 mx-4' />
                    ...
                    <div className='flex flex-row items-center my-2'>
                        ...
                        <input className='ml-2' checked={form.SinDatos} onChange={() => {setForm(prev => ({...prev, SinDatos: !form.SinDatos}))}} type="checkbox" name="SinDatos" id="SinDatos" />
                    </div>
            ...
            <div className='flex justify-between mt-6 mx-12'>
                ...
                <div className='flex gap-1 items-center'>
                    ...
                    <input className="border rounded px-2 py-1 w-24"  name="norden" value={form.norden} onChange={handleInputChange}   />
                    <button type="button" onClick={handlePrint} className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded border border-blue-700 flex items-center shadow-md transition-colors" >
