...
import { PrintHojaR, SubmitOIT, VerifyTR } from './controller/OIT_controller';
        ...
        <h1 className="text-3xl font-bold mb-4 text-center">OIT</h1>
            ...
            <div className='flex justify-between mt-6 mx-12'>
                ...
                <div className='flex gap-1 items-center'>
                    ...
                    <input className="border rounded px-2 py-1 w-24"  name="norden" onChange={handleInputChange}   />
