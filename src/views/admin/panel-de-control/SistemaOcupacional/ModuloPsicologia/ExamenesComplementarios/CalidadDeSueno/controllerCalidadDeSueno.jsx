...
const rutaReporte = "../../../../../../jaspers/ModuloPsicologia/InformePsicoCalidadSueño/CUESTIONARIO_CALIDAD_DE_SUEÑO_Digitalizado.jsx";
        ...
        onExistente: () =>
            GetInfoServicioEditar(nro, tabla, set, token, () => {
                Swal.fire({
                    ...
                    html: "Este paciente ya cuenta con registros de Calidad de Sueño.",
                });
            }),
    });
