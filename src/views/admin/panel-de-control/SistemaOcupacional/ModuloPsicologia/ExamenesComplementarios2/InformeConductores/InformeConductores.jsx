...
import { PrintHojaR, SubmitDataService, UpdateDataService, VerifyTR } from "./controllerInformeConductores";
            ...
            <SectionFieldset legend="Criterios Psicológicos">
                <div className="grid grid-cols-1 gap-4">
                    <InputTextOneLine
                        ...
                        labelWidth="120px"
                        disabled={camposDeshabilitados}
                        edited={isFieldEdited("atencion")}
                        onRevert={() => revertField("atencion")}
                    />
                    <InputTextOneLine
                        label="2.- Concentración"
                        name="concentracion"
                        value={form?.concentracion}
                        onChange={handleChange}
                        labelWidth="120px"
                        disabled={camposDeshabilitados}
                        edited={isFieldEdited("concentracion")}
                        onRevert={() => revertField("concentracion")}
                    />
                    <InputTextOneLine
                        label="3.- Seguridad Y Control de Conducta"
                        name="seguridadYControl"
                        value={form?.seguridadYControl}
                        onChange={handleChange}
                        labelWidth="120px"
                        disabled={camposDeshabilitados}
                        edited={isFieldEdited("seguridadYControl")}
                        onRevert={() => revertField("seguridadYControl")}
                    />
                </div>
            </SectionFieldset>
