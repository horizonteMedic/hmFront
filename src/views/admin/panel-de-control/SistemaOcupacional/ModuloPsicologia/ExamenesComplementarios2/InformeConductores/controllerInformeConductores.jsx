...
const rutaReporte = "../../../../../../jaspers/ModuloPsicologia/InformePsicoConductores/Informe_Psico_Conductores.jsx";
        ...
        onExistente: () =>
            GetInfoServicioEditar(nro, tabla, set, token, () => {
                Swal.fire({
                    ...
                    html: "Este paciente ya cuenta con registros de Informe Conductores.",
                });
            }),
    });
