...
import { PrintHojaR, SubmitDataService, UpdateDataService, VerifyTR } from "./controllerBombaElectrica";
...
export default function BombaElectrica() {
    ...
    const {
        ...
        handleClearnotO,
        handlePrintDefault,
    } = useForm(initialFormState, { storageKey: "BombaElectrica" });
            ...
            <SectionFieldset legend="Criterios Psicológicos">
                <div className="grid grid-cols-1 gap-4">
                    ...
                    <InputTextOneLine
                        ...
                        labelWidth="200px"
                        disabled={camposDeshabilitados}
                        edited={isFieldEdited("manejoDeHerramientas")}
                        onRevert={() => revertField("manejoDeHerramientas")}
                    />
                </div>
            </SectionFieldset>
