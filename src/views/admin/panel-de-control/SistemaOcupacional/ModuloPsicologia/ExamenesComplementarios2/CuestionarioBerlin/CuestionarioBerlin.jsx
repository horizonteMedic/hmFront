...
import { PrintHojaR, SubmitDataService, UpdateDataService, VerifyTR } from "./controllerCuestionarioBerlin";
            ...
            <SectionFieldset legend="Criterios Psicológicos">
                <div className="grid grid-cols-1 gap-4">
                    <InputTextOneLine
                        ...
                        labelWidth="200px"
                        disabled={camposDeshabilitados}
                        edited={isFieldEdited("criterioApneaObstructivaSueno")}
                        onRevert={() => revertField("criterioApneaObstructivaSueno")}
                    />
                    <InputTextOneLine
                        ...
                        labelWidth="200px"
                        disabled={camposDeshabilitados}
                        edited={isFieldEdited("criterioFatigaSomnolencia")}
                        onRevert={() => revertField("criterioFatigaSomnolencia")}
                    />
                    <InputTextOneLine
                        ...
                        labelWidth="200px"
                        disabled={camposDeshabilitados}
                        edited={isFieldEdited("criterioHipertensionArterial")}
                        onRevert={() => revertField("criterioHipertensionArterial")}
                    />
                </div>
            </SectionFieldset>
