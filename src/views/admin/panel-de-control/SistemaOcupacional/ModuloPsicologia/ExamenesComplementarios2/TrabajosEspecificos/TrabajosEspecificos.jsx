...
import { PrintHojaR, SubmitDataService, UpdateDataService, VerifyTR } from "./controllerTrabajosEspecificos";
        ...
        <div className="space-y-3 px-4 max-w-[90%] xl:max-w-[80%] mx-auto">
            ...
            <SectionFieldset legend="Criterios Psicológicos">
                <div className="grid grid-cols-1 gap-4">
                    <InputTextOneLine
                        label="1.- Nivel Alerta ante el Riesgo"
                        name="nivelAlertaRiesgo"
                        value={form?.nivelAlertaRiesgo}
                        onChange={handleChange}
                        labelWidth="120px"
                        disabled={camposDeshabilitados}
                        edited={isFieldEdited("nivelAlertaRiesgo")}
                        onRevert={() => revertField("nivelAlertaRiesgo")}
                    />
                    <InputTextOneLine
                        label="2.- Nivel de Psicomotricidad"
                        name="nivelPsicomotricidad"
                        value={form?.nivelPsicomotricidad}
                        onChange={handleChange}
                        labelWidth="120px"
                        disabled={camposDeshabilitados}
                        edited={isFieldEdited("nivelPsicomotricidad")}
                        onRevert={() => revertField("nivelPsicomotricidad")}
                    />
                </div>
            </SectionFieldset>
