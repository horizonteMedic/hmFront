...
import { PrintHojaR, SubmitDataService, UpdateDataService, VerifyTR } from "./controllerExamenesComplementariosForm";
        ...
        <div className="space-y-3 px-4 max-w-[90%] xl:max-w-[80%] mx-auto">
            ...
            <SectionFieldset legend="Criterios Psicológicos">
                <div className="grid grid-cols-1 gap-4">
                    <InputTextOneLine
                        label="1.- Nivel de Autoconciencia"
                        name="nivelAutoconciencia"
                        value={form?.nivelAutoconciencia}
                        onChange={handleChange}
                        labelWidth="170px"
                        disabled={camposDeshabilitados}
                        edited={isFieldEdited("nivelAutoconciencia")}
                        onRevert={() => revertField("nivelAutoconciencia")}
                    />
                    <InputTextOneLine
                        label="2.- Nivel de Autoconfianza"
                        name="nivelAutoconfianza"
                        value={form?.nivelAutoconfianza}
                        onChange={handleChange}
                        labelWidth="170px"
                        disabled={camposDeshabilitados}
                        edited={isFieldEdited("nivelAutoconfianza")}
                        onRevert={() => revertField("nivelAutoconfianza")}
                    />
                    <InputTextOneLine
                        label="3.- Nivel de Autorregulación"
                        name="nivelAutoregulacion"
                        value={form?.nivelAutoregulacion}
                        onChange={handleChange}
                        labelWidth="170px"
                        disabled={camposDeshabilitados}
                        edited={isFieldEdited("nivelAutoregulacion")}
                        onRevert={() => revertField("nivelAutoregulacion")}
                    />
                    <InputTextOneLine
                        label="4.- Nivel de Motivación"
                        name="nivelMotivacion"
                        value={form?.nivelMotivacion}
                        onChange={handleChange}
                        labelWidth="170px"
                        disabled={camposDeshabilitados}
                        edited={isFieldEdited("nivelMotivacion")}
                        onRevert={() => revertField("nivelMotivacion")}
                    />
                    <InputTextOneLine
                        label="5.- Nivel de Empatía"
                        name="nivelEmpatia"
                        value={form?.nivelEmpatia}
                        onChange={handleChange}
                        labelWidth="170px"
                        disabled={camposDeshabilitados}
                        edited={isFieldEdited("nivelEmpatia")}
                        onRevert={() => revertField("nivelEmpatia")}
                    />
                    <InputTextOneLine
                        label="6.- Nivel de Competencia Social"
                        name="nivelCompetenciaSocial"
                        value={form?.nivelCompetenciaSocial}
                        onChange={handleChange}
                        labelWidth="170px"
                        disabled={camposDeshabilitados}
                        edited={isFieldEdited("nivelCompetenciaSocial")}
                        onRevert={() => revertField("nivelCompetenciaSocial")}
                    />
                </div>
            </SectionFieldset>
