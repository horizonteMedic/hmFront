...
import { faSave, faPrint, faTrash, faCalendar } from "@fortawesome/free-solid-svg-icons";
import { 
  InputTextOneLine, 
  InputTextArea, 
  InputCheckbox, 
...
// Componente para Ficha Aptitud Anexo 2
export default function FichaAptitudAnexo2({
  ...
  // Función para manejar cambios en checkboxes de aptitud
  const handleAptitudChange = (name, checked) => {
    setForm(prev => {
  ...
  />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Columna 1: Médico que Certifica y Botones */}
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <InputTextOneLine
