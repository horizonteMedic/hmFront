...
import { GetExamenesRealizados, handleSubirArchivo, handleSubirArchivoMasivo, PrintHojaR, ReadArchivosForm, SubmitDataService, VerifyTR } from "./controllerAnexo16Test";
...
export default function Anexo16Test({ SinReestricciones = false }) {
  ...
  const {
    ...
    handleClearnotO,
    handleBlur
  } = useForm(initialFormState, { storageKey: "anexo_16_test" });
