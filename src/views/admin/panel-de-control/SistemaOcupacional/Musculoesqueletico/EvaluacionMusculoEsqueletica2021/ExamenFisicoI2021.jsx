      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="border rounded-lg p-6 bg-gray-50">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4 mr-3">
              <div></div>
              <div className="font-semibold text-end text-blue-900">Puntos</div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-4">
                ...
                <input
                  type="text"
                  className="border rounded px-3 py-2 w-20 text-center mx-auto"
              ...
              <div className="grid grid-cols-4">
                <span className="font-medium">
                  Rotación externa hombro interna:
                </span>
                <div />
                <input
                  type="text"
              ...
              {/* Total */}
              <div className="grid grid-cols-4 pt-3 border-t">
                <span className="font-bold text-blue-900">Total:</span>
                <div/>
                <input
                  type="text"
                  className="border rounded px-3 py-2 w-20 text-center font-bold mx-auto text-blue-900"
