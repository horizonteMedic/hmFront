...
const BASIC_HEADERS = [
    { key: "item",                  label: "N°",              width: 6  },
    { key: "codigo de paciente",    label: "CÓD. PACIENTE",   width: 16 },
...
const ModalContabilidad = ({ onClose, sede, token }) => {
    ...
    const generarExcel = async (data) => {
        ...
        const lastCol = String.fromCharCode(64 + totalCols); // A=65
        ...
        groupCell.fill      = { type: "pattern", pattern: "solid", fgColor: { argb: "FF833C00" } };
        ...
        data.forEach((item, rowIdx) => {
            ...
            row.eachCell((cell, colNumber) => {
                ...
                cell.font = {
                    ...
                    color: { argb: isExam && cell.value === "SI" ? "FF833C00" : "FF000000" },
                };
                cell.fill = {
        ...
        totalCell.value     = `TOTAL: ${data.length} registros`;
