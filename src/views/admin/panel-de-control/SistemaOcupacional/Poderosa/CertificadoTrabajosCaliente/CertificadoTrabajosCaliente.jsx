...
import { PrintHojaR, SubmitDataService, UpdateDataService, VerifyTR } from "./ControllerCertCaliente";
...
const CertificadoTrabajosCaliente = () => {
    ...
    } = useForm(initialFormState, { storageKey: "CertificadoTrabajosCaliente" });
