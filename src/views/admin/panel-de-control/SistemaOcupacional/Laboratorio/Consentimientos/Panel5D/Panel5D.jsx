...
import { PrintHojaR, SubmitDataService, UpdateDataService, VerifyTR } from './controllerPanel5D';
...
const Panel5D = () => {
  ...
  const { form, setForm, handleChange, handleChangeSimple, handleClear, handlePrintDefault } = useForm(initialFormState, { storageKey: "consPanel5D" });
  ...
  const handlePrint = () => {
    ...
    }, '¿Desea Imprimir Consentimiento Panel 5D?', form.norden);
  };
