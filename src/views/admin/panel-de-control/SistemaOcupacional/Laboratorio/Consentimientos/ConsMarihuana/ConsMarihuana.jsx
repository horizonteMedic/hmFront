...
import { PrintHojaR, SubmitDataService, UpdateDataService, VerifyTR } from './controllerConsMarihuana';
...
const ConsMarihuana = () => {
  ...
  const { form, setForm, handleChange, handleChangeSimple, handleClear, handlePrintDefault } = useForm(initialFormState, { storageKey: "consMarihuana" });
  ...
  const handlePrint = () => {
    ...
    }, '¿Desea Imprimir Consentimiento Marihuana?', form.norden);
  };
  ...
  return (
    <div className="w-full max-w-[70vw] mx-auto bg-white rounded shadow p-6">
      ...
      <h2 className="text-2xl font-bold text-center mb-6">CONSENTIMIENTO INFORMADO PARA REALIZAR LA PRUEBA DE DOSAJE DE MARIHUANA</h2>
