...
const Altura = ({ token, selectedSede }) => {
  return (
    <div className="max-w-4xl mx-auto bg-white rounded shadow p-8">
      <h2 className="text-2xl font-bold mb-6 text-center">TEST ALTURA</h2>
      <form className="space-y-4">
        ...
        <div className="flex gap-8 mt-6">
          <div className="flex flex-col gap-2 flex-1">
            ...
            <label className="flex items-center gap-2">Grupo Sanguíneo :</label>
            <label className="flex items-center gap-2">Factor Rh :</label>
            <label className="flex items-center gap-2">Hemoglobina :</label>
            <label className="flex items-center gap-2">Hematocrito :</label>
            <label className="flex items-center gap-2">Glucosa :</label>
          </div>
          <div className="flex flex-col gap-2 flex-1">
