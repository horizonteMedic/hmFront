...
const Gonadotropina = ({ token, selectedSede }) => {
  return (
    <div className="max-w-4xl mx-auto bg-white rounded shadow p-8">
      <h2 className="text-2xl font-bold mb-6 text-center">GONADOTROPINA</h2>
      <form className="space-y-4">
        ...
        <div className="flex gap-8 mt-6">
          <div className="flex flex-col gap-2 flex-1">
            ...
            <label className="flex items-center gap-2">GONADOTROPINA CORIÓNICA HUMANA</label>
          </div>
          <div className="flex flex-col gap-2 flex-1">
            <span className="font-bold">RESULTADOS</span>
            <input className="border rounded px-2 py-1" />
            <div className="flex items-center gap-2 mt-2">
              <input type="radio" name="gonadotropina" /> NEGATIVO
              <input type="radio" name="gonadotropina" /> POSITIVO
            </div>
          </div>
