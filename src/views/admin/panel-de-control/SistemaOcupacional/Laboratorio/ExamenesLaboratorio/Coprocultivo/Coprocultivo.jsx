      ...
      <form className="space-y-4">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center">
          <div className="flex-1 flex gap-2 items-center">
            ...
            <input className="border rounded px-2 py-1 bg-gray-100" name="nombres" value={form.nombres} onChange={handleInputChange} 
              style={{ minWidth: '120px', maxWidth: '400px', width: `${Math.min(400, Math.max(120, (form.nombres?.length || 0) * 10))}px` }} disabled />
          </div>
          <div className="flex-1 flex gap-2 items-center">
            <label className="font-semibold">Edad:</label>
            <input className="border rounded px-2 py-1 w-24 bg-gray-100" name="edad" value={form.edad} onChange={handleInputChange} disabled />
          </div>
        </div>
