...
const obtenerReporteUrl = "/api/v01/ct/inmunologia/obtenerReporteLgonadotropina";
const registrarUrl = "/api/v01/ct/inmunologia/registrarActualizarLgonadotropina";
...
export const GetInfoServicioEditar = async (nro, tabla, set, token, onFinish = () => { }) => {
  ...
  if (res) {
    set((prev) => ({
      ...
      resultado: res.txtResultado ?? "NEGATIVO",
    ...
    onExistente: () =>
      GetInfoServicioEditar(nro, tabla, set, token, () => {
        Swal.fire({
          ...
          html: "Este paciente ya cuenta con registros de Gonadotropina.",
        });
      }),
  });
