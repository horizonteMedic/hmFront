...
const obtenerReporteUrl = "/api/v01/ct/toxicologia/obtenerReportePanel2D";
const registrarUrl = "/api/v01/ct/toxicologia/registrarActualizarPanel2D";
    ...
    onExistente: () =>
      GetInfoServicioEditar(nro, tabla, set, token, () => {
        Swal.fire({
          ...
          html: "Este paciente ya cuenta con registros de Panel 2D.",
        });
      }),
  });
