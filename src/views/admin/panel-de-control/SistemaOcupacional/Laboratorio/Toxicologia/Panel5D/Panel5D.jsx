...
export default function Panel5D() {
        ...
        <div className="grid gap-x-4 gap-y-3">
          ...
          <div className="flex gap-4">
            <InputTextOneLine
              ...
              className='w-full max-w-[85%]'
              disabled={camposDeshabilitados}
              edited={isFieldEdited("valueAn")}
              onRevert={() => revertField("valueAn")}
            />
            <InputsRadioGroup
              name="valueAn"
              value={form.valueAn}
          ...
          <div className="flex gap-4">
            <InputTextOneLine
              ...
              className='w-full max-w-[85%]'
              disabled={camposDeshabilitados}
              edited={isFieldEdited("valueBen")}
              onRevert={() => revertField("valueBen")}
            />
            <InputsRadioGroup
              name="valueBen"
              value={form.valueBen}
