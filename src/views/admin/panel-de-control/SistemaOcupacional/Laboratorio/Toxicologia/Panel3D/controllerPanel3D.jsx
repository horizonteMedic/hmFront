...
const obtenerReporteUrl = "/api/v01/ct/toxicologia/obtenerReportePanel3D";
const registrarUrl = "/api/v01/ct/toxicologia/registrarActualizarPanel3D";
    ...
    onExistente: () =>
      GetInfoServicioEditar(nro, tabla, set, token, () => {
        Swal.fire({
          ...
          html: "Este paciente ya cuenta con registros de Panel 3D.",
        });
      }),
  });
