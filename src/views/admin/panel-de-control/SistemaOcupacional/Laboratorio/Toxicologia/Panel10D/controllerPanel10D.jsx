...
const obtenerReporteUrl = "/api/v01/ct/toxicologia/obtenerReportePanel10D";
const registrarUrl = "/api/v01/ct/toxicologia/registrarActualizarPanel10D";
    ...
    onExistente: () =>
      GetInfoServicioEditar(nro, tabla, set, token, () => {
        Swal.fire({
          ...
          html: "Este paciente ya cuenta con registros de Panel 10D.",
        });
      }),
  });
