...
export default function PcuanAntigenos({ apiBase, token, selectedSede }) {
  ...
  return (
    <form className="w-full max-w-4xl mx-auto bg-white p-8 rounded shadow" onSubmit={e => { e.preventDefault(); handleSave(); }}>
      {/* Título principal */}
      <div className="text-2xl font-bold text-center mb-8">COVID-19 Prueba Rápida (Antígeno)</div>
      ...
      <div className="border rounded p-4 mb-8">
        ...
        <div className="flex flex-wrap gap-6 items-start">
          <div className="flex flex-col gap-4 flex-1 min-w-[260px]">
            ...
            <div className="flex items-center gap-2">
              <label className="font-semibold text-base min-w-[70px]">Valor:</label>
              <input name="valor" value={form.valor} onChange={handleChange} className="border rounded px-2 py-1 flex-1" />
            </div>
          </div>
          {/* Cuadro de técnica */}
          <div className="flex-1 min-w-[260px]">
            <div className="border rounded bg-gray-50 p-4 text-base min-h-[100px]" style={{ minWidth: 220 }}>
