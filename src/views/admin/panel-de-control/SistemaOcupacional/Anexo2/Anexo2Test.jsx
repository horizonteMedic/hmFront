...
import { GetExamenesRealizados, handleSubirArchivo, handleSubirArchivoMasivo, PrintHojaR, ReadArchivosForm, SubmitDataService, VerifyTR } from "./controllerAnexo2Test";
...
export default function Anexo2Test({ SinReestricciones = false }) {
  ...
  const {
    ...
    handleClearnotO,
    handlePrintDefault,
  } = useForm(initialFormState, { storageKey: "anexo_2_test" });
