...
// Campos "core" que el usuario puede editar (para resaltar/revertir cambios).
...
export default function EKG() {
  ...
  return (
    <div className="px-4 max-w-[90%] xl:max-w-[80%] mx-auto space-y-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-6 gap-y-6">
        ...
        <div className="space-y-3">
          ...
          <DatosPersonalesLaborales minSizePrincipal="none" minSizeSecundario="none" form={form} />
          ...
          >
            ...
            <InputTextOneLine
              ...
              onKeyUp={handleFocusNext}
              disabled={camposDeshabilitados}
              edited={isFieldEdited("fc")}
              onRevert={() => revertField("fc")}
            />
            ...
            <InputTextOneLine
              ...
              onKeyUp={handleFocusNext}
              disabled={camposDeshabilitados}
              edited={isFieldEdited("eje")}
              onRevert={() => revertField("eje")}
            />
            ...
            <InputTextOneLine
              ...
              onKeyUp={handleFocusNext}
              disabled={camposDeshabilitados}
              edited={isFieldEdited("pr")}
              onRevert={() => revertField("pr")}
            />
            ...
            <InputTextOneLine
              ...
              onKeyUp={handleFocusNext}
              disabled={camposDeshabilitados}
              edited={isFieldEdited("qrs")}
              onRevert={() => revertField("qrs")}
            />
            ...
            <InputTextOneLine
              ...
              onKeyUp={handleFocusNext}
              disabled={camposDeshabilitados}
              edited={isFieldEdited("qtc")}
              onRevert={() => revertField("qtc")}
            />
            ...
            <InputTextOneLine
              ...
              value={form.st ?? ""}
              onChange={handleChange}
              disabled={!form.informeCompleto || camposDeshabilitados}
              labelWidth="80px"
              onKeyUp={handleFocusNext}
              edited={isFieldEdited("st")}
              onRevert={() => revertField("st")}
            />
            ...
            <InputTextOneLine
              ...
              labelWidth="80px"
              onKeyUp={handleFocusNext}
              edited={isFieldEdited("ondaT")}
              onRevert={() => revertField("ondaT")}
            />
            ...
            <InputTextOneLine
              ...
              labelWidth="80px"
              onKeyUp={handleFocusNext}
              edited={isFieldEdited("ondaP")}
              onRevert={() => revertField("ondaP")}
            />
          </SectionFieldset>
          ...
          <SectionFieldset legend="Conclusiones y Recomendaciones" className="space-y-3">
            <InputTextArea
              ...
              onChange={handleChange}
              disabled={camposDeshabilitados}
              edited={isFieldEdited("hallazgos")}
              onRevert={() => revertField("hallazgos")}
            />
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 gap-4">
              ...
              <InputCheckbox
                ...
                onChange={(e) => {
                  ...
                  setForm((prev) => ({
                    ...prev,
                    recomendaciones: e.target.checked ? "" : prev.recomendaciones,
                  }));
                }}
              />
