...
const ConfiguracionVistasPorRol = () => {
  ...
  const roles = ['Vista1', 'Vista2', 'Vista3', 'Vista4', 'Vista5', 'Vista6', 'Vista7', 'Vista8', 'Vista9', 'Vista10', 'Vista11', 'Vista12', 'Vista13', 'Vista14', 'Vista15'];
        ...
        <div className="mb-4">
          ...
          >
            <option value="" >Selecciona un rol</option>
              {vistas.map((rol) => ( <option key={rol} value={rol}> {rol}
              </option>
            ))}
          </select>
        </div>
