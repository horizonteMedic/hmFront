...
export const InputText = (props) => {
    return (
            ...
            <div className="h-full">
                <label htmlFor={props.name} className="text-sm font-semibold text-white" style={{ fontSize: '15px' }}>{props.name}:</label>
                <input type="text" id={props.name} name={props.name} maxLength={props.name === 'dni' && 8} value={props.value} 
                onChange={props.handleChange} className="text-black form-input border rounded w-full h-10" />
...
export const InputSelect = (props) => {
    ...
    return (
            ...
            <div className="h-full">
                <label htmlFor={props.name} className="text-sm font-semibold text-white" style={{ fontSize: '15px' }}>{props.name}:</label>
                <select id={props.name} name={props.name} value={props.value} onChange={props.handleChange} className="text-black form-select text-sm cursor-pointer p-1 border rounded w-full">
