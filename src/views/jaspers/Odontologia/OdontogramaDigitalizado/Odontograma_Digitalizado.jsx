...
export default async function Odontograma_Digitalizado(datos = {}, docExistente = null) {
  ...
  doc.text("FICHA ODONTOGRAFICA DE IDENTIFICACION DE PERSONAL", pageW / 2, 32, { align: "center" });
