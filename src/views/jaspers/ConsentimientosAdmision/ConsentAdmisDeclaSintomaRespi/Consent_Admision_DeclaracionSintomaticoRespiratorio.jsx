...
export default async function ConsentAdmisionDeclaracionSintomaticoRespiratorio(data = {}, docExistente = null) {
  ...
  // Dibujar texto con partes en negrita
  let xActual = margin;
  let yActual = yPos;
  ...
  doc.setFont("helvetica", "normal");
  const textoDni = " años de edad, identificado con DNI: ";
  ...
  const lineas2 = doc.splitTextToSize(texto2, anchoTexto);
