...
import header_EvaluacionOftalmologica2021_Digitalizado_ohla from "./headers/header_EvaluacionOftalmologica2021_Digitalizado_ohla"
...
export default async function EvaluacionOftalmologica2021_Digitalizado_ohla(
    ...
    const datosPrueba = {
        ...
        txtAvConRefraccionLejosOi: "20/20",
        txtAvConRefraccionCercaOd: "20/20",
        txtAvConRefraccionCercaOi: "20/20",
        diagnostico: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
