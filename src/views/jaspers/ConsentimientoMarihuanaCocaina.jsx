...
export default function ConsentimientoMarihuanaCocaina(datos) {
  const doc = new jsPDF();
  header(doc, datos);
  ...
  doc.setFontSize(11);
  doc.text('CONSENTIMIENTO INFORMADO PARA REALIZAR LA PRUEBA DE DOSAJE DE MARIHUANA Y COCAINA', 105, y, { align: 'center' });
