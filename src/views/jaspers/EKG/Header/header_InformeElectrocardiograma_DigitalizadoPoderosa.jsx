...
const HeaderInformeElectrocardiogramaPoderosa = (doc, datos) => {
  ...
  const datosFinales = { ...datosPrueba, ...datos };
  ...
  const examTitle = "INFORME : ELECTROCARDIOGRAMA";
  ...
  doc.setFont("helvetica", "bold");
  doc.text(datosFinales.apellidos + " " + datosFinales.nombres || "", tableX + 35, tableY + 13);
  ...
  doc.setFont("helvetica", "bold");
  doc.text(datosFinales.antecedentesCardiologicos || "", tableX + 25, tableY + 29);
