...
export default async function Anexo16A_Digitalizado(data = {}, docExistente = null) {
  ...
  // Tercera fila: Área de Trabajo (fila completa con altura dinámica)
  ...
  // Tercera fila: Área de Trabajo (fila completa)
  doc.setFont("helvetica", "bold").setFontSize(8);
  ...
  dibujarTextoConSaltoLinea(empresaTexto || "N/A", tablaInicioX + 24, yTexto + 1.5, tablaAncho - 30);
  yTexto += filaAltura;
