const headerAnexo16A_Digitalizado = (doc, datos, numeroPagina = 1) => {
  ...
  // Datos fijos para Anexo16A Digitalizado
  const datosFijos = {
  ...
  const datosReales = {
    ...
    tipoExamen: datos?.nombreExamen_nom_examen ?? "ANEXO 16-A",
  };
...
export default headerAnexo16A_Digitalizado;
