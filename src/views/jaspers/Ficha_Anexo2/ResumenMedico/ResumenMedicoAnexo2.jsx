...
export default async function ResumenMedicoAnexo2(data = {}, docExistente = null) {
    ...
    const datosReales = {
        ...
        antecedentesPersonales: String(data.antecedentesAnexo02 ?? ""),
        aptitudAnexo02: String(data.aptitudAnexo02 ?? ""),
        fechaVencimientoAnexo02: formatearFechaCorta(data.fechaVencimientoAnexo02 ?? ""),
        ...
        evaluaciones: {
            ...
            espirometria: String(data.espirometriaInterpretacion || "N/A"),
            ...
            psicologico: String(data.aproboPsicologico_aprobo_inf ?? ""),
        ...
        restriccionesAnexo02: String(data.restriccionesAnexo02 ?? ""),
        observaciones: String(data.observacionesFichaMedicaAnexo7c_txtobservacionesfm ?? ""),
        observacionesAnexo2_txtobservacionesfm: String(data.observacionesAnexo2_txtobservacionesfm ?? "")
    };
    ...
    const drawHeader = async (pageNumber) => {
        ...
        if (pageNumber === 1) {
            ...
            doc.text("RESUMEN MÉDICO", pageW / 2, 30, { align: "center" });
        }
    ...
    doc.setFont("helvetica", "normal").setFontSize(8);
    doc.text(datosFinales.aptitudAnexo02 || "", tablaInicioX + 35, yTextoAptitud);

    // Segunda columna: FECHA DE VENCIMIENTO
    doc.setFont("helvetica", "bold").setFontSize(8);
    doc.text("FECHA DE VENCIMIENTO:", tablaInicioX + 102, yTextoAptitud);
    doc.setFont("helvetica", "normal").setFontSize(8);
    doc.text(datosFinales.fechaVencimientoAnexo02 || "", tablaInicioX + 155, yTextoAptitud);
