 ...
 * @param {jsPDF} doc
 */
const body_Audiometria2021_Digitalizado_boro = (doc, data) => {
  // Header
...
export default function Audiometria2021_Digitalizado_boro(data = {}) {
  const doc = new jsPDF({ unit: "mm", format: "a4", orientation: "portrait" });
  body_Audiometria2021_Digitalizado_boro(doc,data);
