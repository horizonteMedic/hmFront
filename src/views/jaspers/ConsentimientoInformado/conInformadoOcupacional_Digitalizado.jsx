...
export default async function conInformadoOcupacional_Digitalizado(data = {}, docExistente = null) {
    ...
    const s1 = await getSignCompressed(data, "FIRMAP");
    const s2 = await getSignCompressed(data, "HUELLA");
    ...
    if (s2) {
        ...
        // Tamaño fijo ajustado para huella comprimida
        // getSignCompressed returns a base64 image data URI or null
        const imgX = huellaX + 2;
        const imgY = huellaY + 2;
        const imgW = maxImgW;
        const imgH = maxImgH;

        doc.addImage(s2, "PNG", imgX, imgY, imgW, imgH);
    }
    ...
    if (s1) {
        ...
        // Tamaño fijo para firma optimizada
        const imgW = 60;
        const imgH = 25;
        ...
        doc.addImage(s1, "PNG", imgX, imgY, imgW, imgH);
    }
