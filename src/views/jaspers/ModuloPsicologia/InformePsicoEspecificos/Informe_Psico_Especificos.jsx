...
export default function InformePsicoEspecificos(data = {}, docExistente = null) {
  ...
  function buildDatosFinales(raw) {
    const datosFinales = {
      ...
      nivelAlertaRiesgo: String(raw?.criterioNivelAlertRiesgo ?? raw?.nivelAlertaRiesgo ?? ''),
      nivelPsicomotricidad: String(raw?.criterioNivelPsicomotrocidad ?? raw?.nivelPsicomotricidad ?? ''),
