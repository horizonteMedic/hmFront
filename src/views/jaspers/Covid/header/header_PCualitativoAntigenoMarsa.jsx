...
/**
 * Dibuja el encabezado para el reporte de Prueba Cualitativa de Antígenos (Marsa).
 ...
 */
const header_PCualitativoAntigenoMarsa = (doc, datos = {}) => {
  const margin = 15;
...
export default header_PCualitativoAntigenoMarsa; 