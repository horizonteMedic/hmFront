...
const header_PCuantiAntigeno = (doc, datos = {}) => {
  ...
  doc.line(
    nroOrdenX + nroOrdenLabelWidth + 2,
    y + 6.5,
    nroOrdenX + nroOrdenLabelWidth + 2 + nroOrdenValueWidth,
    y + 6.5
  );
  ...
  doc.text(datos.sede || "Trujillo-Pierola", rightColX, y + 11, {
    align: "right",
  });
  ...
  doc.text(
    formatDateToShort(datos.fechaExamen),
    patientDataX + fechaLabelWidth + 2,
    y
  );
