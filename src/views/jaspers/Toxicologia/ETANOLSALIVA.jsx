...
export default async function ETANOLSALIVA(datos = {}, docExistente = null) {
  ...
  doc.text(String(datos.muestra), config.margin + 20, y);
  y += config.lineHeight;
  ...
  doc.text("PRUEBA RÁPIDA EN TIRA DE ALCOHOL EN SALIVA (MONTEST)" || '', config.col1X, y + 6,);
