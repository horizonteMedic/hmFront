...
export default async function Consentimiento_Panel4d_Digitalizado(datos = {}, docExistente = null) {
  ...
  const linea1 = 'CONSENTIMIENTO INFORMADO PARA REALIZAR LA PRUEBA DE DOSAJE DE';
  const linea2 = 'COCAÍNA, MARIHUANA, OPIÁCEOS Y METHANFETAMINAS';
  ...
  await dibujarFirmas({ doc, datos, y: baseY, pageW }).then(() => {
    footerTR(doc, datos);
  })
