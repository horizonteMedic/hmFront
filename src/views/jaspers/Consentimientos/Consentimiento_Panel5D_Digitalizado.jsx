   ...
   .then(([huellap, firmap, sellop]) => {
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        ['CONSUME ÉXTASIS ', `NO (${!datos.antConsumeAnfetaminaOExtasis ? "X" : "    "})`, `SI (${datos.antConsumeAnfetaminaOExtasis ? "X" : "    "})`, datos.antConsumeAnfetaminaOExtasis && datos.fechaConsumeAnfetamina ? `Cuando: ${(() => { const f = new Date(datos.fechaConsumeAnfetamina); return `${String(f.getDate()).padStart(2, '0')}/${String(f.getMonth() + 1).padStart(2, '0')}/${f.getFullYear()}`; })()}` : ''],
        ['CONSUME OPIÁCEOS ', `NO (${!datos.antConsumeMethanfetaminaOOpiaceos ? "X" : "    "})`, `SI (${datos.antConsumeMethanfetaminaOOpiaceos ? "X" : "    "})`, datos.antConsumeMethanfetaminaOOpiaceos && datos.fechaConsumeOpiacesos ? `Cuando: ${(() => { const f = new Date(datos.fechaConsumeOpiacesos); return `${String(f.getDate()).padStart(2, '0')}/${String(f.getMonth() + 1).padStart(2, '0')}/${f.getFullYear()}`; })()}` : ''],
