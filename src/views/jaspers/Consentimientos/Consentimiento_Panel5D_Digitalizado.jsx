  ...
  Promise.all([
   ...
   .then(([huellap, firmap, sellop]) => {
    ...
    autoTable(doc, {
      startY: y,
      body: [
        ['CONSUME MARIHUANA ', `NO (${!datos.antConsumeMarih ? "X" : "    "})`, `SI (${datos.antConsumeMarih ? "X" : "    "})`, datos.antConsumeMarih && datos.fechaConsumeMarih ? `Cuando: ${datos.fechaConsumeMarih}` : ''],
        ...
        ['CONSUME ÉXTASIS ', `NO (${!datos.antConsumeAnfetaminaOExtasis ? "X" : "    "})`, `SI (${datos.antConsumeAnfetaminaOExtasis ? "X" : "    "})`, datos.antConsumeAnfetaminaOExtasis && datos.fechaConsumeAnfetamina ? `Cuando: ${datos.fechaConsumeAnfetamina}` : ''],
        ['CONSUME OPIÁCEOS ', `NO (${!datos.antConsumeMethanfetaminaOOpiaceos ? "X" : "    "})`, `SI (${datos.antConsumeMethanfetaminaOOpiaceos ? "X" : "    "})`, datos.antConsumeMethanfetaminaOOpiaceos && datos.fechaConsumeMethanfetamina ? `Cuando: ${datos.fechaConsumeMethanfetamina}` : ''],
