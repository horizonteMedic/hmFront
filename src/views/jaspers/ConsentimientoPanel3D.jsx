...
export default function ConsentimientoPanel3D(datos) {
  const doc = new jsPDF();
  header(doc, datos);
  ...
  doc.setFontSize(11);
  doc.text('CONSENTIMIENTO INFORMADO PARA REALIZAR LA PRUEBA DE DROGAS PANEL 3D', 105, y, { align: 'center' });
  ...
  y += 10;
  let texto = `Yo......................................................................................., de ....... años de\nedad, identificado con DNI nº ......................... ............................; habiendo recibido consejería e información\nacerca de la prueba para el panel de 3D drogas en orina; y en pleno uso de mis facultades mentales AUTORIZO se me tome la muestra para el dosaje de dichas sustancias, así mismo me comprometo a regresar para recibir la consejería Post - Test y mis resultados.`;
  ...
  autoTable(doc, {
    ...
    body: [
      ...
      ['CONSUME HOJA DE COCA EN LOS 7 DIAS PREVIOS', `NO (${datos.ant_coca_no || ''})`, `SI (${datos.ant_coca_si || ''})`],
